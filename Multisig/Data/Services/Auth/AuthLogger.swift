...
enum AuthLogger {
    ...
    static func log(_ message: @autoclosure () -> String,
        ...
        let formattedMessage = "🔐 [AUTH] \(message())"
        switch level {
        case .debug:
    ...
    static func success(_ message: @autoclosure () -> String,
                        ...
                        function: StaticString = #function) {
        #if MULTISIG_DEV_LOGS
        LogService.shared.info("✅ 🔐 [AUTH] \(message())", file: file, line: line, function: function)
        #endif
    }
    ...
    static func network(_ message: @autoclosure () -> String,
                        ...
                        function: StaticString = #function) {
        #if MULTISIG_DEV_LOGS
        LogService.shared.debug("🌐 🔐 [AUTH] \(message())", file: file, line: line, function: function)
        #endif
    }
    
    static func stateTransition(_ message: @autoclosure () -> String,
                                file: StaticString = #file,
                                line: UInt = #line,
                                function: StaticString = #function) {
        #if MULTISIG_DEV_LOGS
